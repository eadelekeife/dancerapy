                                                        ...
                                                        {userPlans.map((plan, index) => {
                                                            return (
                                                                <Collapse defaultActiveKey={['1']} key={index}>
                                                                    <Panel key={index + 1}
                                                                        header={`${plan.coursePlan.title} purchased on ${DateTime.fromISO(plan.createdAt).toLocaleString(DateTime.DATE_HUGE)}`}>
                                            ...
                                            <div>
                                                <div className="empty_div">
                                                    <div>
                                                        ...
                                                        <Link to={AppRoute.trainings} className="btn-red">View Plans</Link>
                                                    </div>
                                                </div>
                                            </div>
                            }
